		...
		preset = {
			...
			keys = {
				...
				},
				{
					...
					key = "q",
					desc = "Quit",
					action = function() vim.cmd "silent! qa!" end,
				},
			},
		},
	},
...
vim.keymap.set("n", "<leader>fw", function() Snacks.picker.grep_word() end, { desc = "Search current Word" })
vim.keymap.set("n", "<leader>fr", function() Snacks.picker.recent() end, { desc = "Search Recent Files" })
vim.keymap.set("n", "<leader>fh", function() Snacks.picker.help() end, { desc = "Search Help" })
vim.keymap.set("n", "<leader>fk", function() Snacks.picker.keymaps() end, { desc = "Search Keymaps" })
